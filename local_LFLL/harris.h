...
/*
   # NOTE-1: WHAT IS intptr_t??  It's defined in stdint.h as follows:
          
                    typedef long int intptr_t;

        Actually, It is a signed integer type that is big enough to hold a pointer.

    
    # NOTE-2: AND WHAT IS   "sval_t"    ??
            
            Under the header file common.h, sval_t is defined as follows:

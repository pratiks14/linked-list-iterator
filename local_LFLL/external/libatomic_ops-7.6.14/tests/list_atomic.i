# 0 "list_atomic.c"
# 1 "/home/ayaz/Desktop/ICDCN/local_LFLL/external/libatomic_ops-7.6.14/tests//"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 91 "../src/atomic_ops/sysdeps/gcc/generic.h" 2
  ...
  AO_test_and_set(volatile unsigned char *addr)
  {
    return (AO_BYTE_TS_val)(__atomic_test_and_set(addr, 0)
                         ? AO_BYTE_TS_set : AO_BYTE_TS_clear);
  }
...
# 307 "../src/atomic_ops.h" 2
# 455 "../src/atomic_ops.h"
